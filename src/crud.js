...
class ApiTen extends Component{
    constructor(){
        super();
        this.state = {
            userlist:[],
    ...
    deleteUser=(userid)=>{
        ...
        let input = {"id":userid};
        input=JSON.stringify(input);//convert into array to json
    ...
    render(){
        ...
        <button className="btn btn-primary" onClick={this.saveitem}>Save User</button>
                    </div>
                </div>
                                   ...
                                   this.state.userlist.map((xuser , index)=>{
                                       return(
                                           <tr key={index}>
                                               ...
                                               <td> {xuser.mobile} </td>
                                               <td>
                                                   <button onClick={this.deleteUser.bind(this,xuser.id)}>Delete</button>
                                               </td>
                                           </tr>
                                       )
                                   })
